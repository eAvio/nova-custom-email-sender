 ...
 export default {
	...
	drafts(offset = null, limit = null) {
		return new Promise((resolve, reject) => {
			Nova.request()
				.get(`/nova-vendor/custom-email-sender/nebula-sender-drafts`, {
					params: {
						offset,
						limit
					}
	...
	draft(id) {
		return new Promise((resolve, reject) => {
			Nova.request()
				.get(`/nova-vendor/custom-email-sender/nebula-sender-drafts/${id}`)
				.then(success => {
					return resolve(success.data);
				})
				.catch(error => {
	...
	createDraft(
		...
		return new Promise((resolve, reject) => {
			Nova.request()
				.post(`/nova-vendor/custom-email-sender/nebula-sender-drafts`, {
					from,
					template,
					content,
					subject,
	...
	updateDraft(
		...
		return new Promise((resolve, reject) => {
			Nova.request()
				.put(`/nova-vendor/custom-email-sender/nebula-sender-drafts/${id}`, {
					from,
					template,
					content,
					subject,
	...
	deleteDraft(id) {
		return new Promise((resolve, reject) => {
			Nova.request()
				.delete(`/nova-vendor/custom-email-sender/nebula-sender-drafts/${id}`)
				.then(success => {
					return resolve(success.data);
				})
				.catch(error => {
	...
	messages(offset = null, limit = null) {
		return new Promise((resolve, reject) => {
			Nova.request()
				.get(`/nova-vendor/custom-email-sender/nebula-sender-messages`, {
					params: {
						offset,
						limit
					}
	...
	clone(messageId) {
		return new Promise((resolve, reject) => {
			Nova.request()
				.post(
					`/nova-vendor/custom-email-sender/nebula-sender-clone/${messageId}`,
					{
						//
					}
				)
